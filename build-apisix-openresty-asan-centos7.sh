...
yum -y install ccache gcc make perl clang patch wget git sudo
yum -y install openresty-openssl111-asan-devel openresty-pcre-asan-devel openresty-zlib-asan-devel

export openssl_prefix=/usr/local/openresty-asan/openssl111
